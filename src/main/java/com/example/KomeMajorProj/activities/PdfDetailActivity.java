...
import com.example.KomeMajorProj.adapters.AdaptComment;
import com.example.KomeMajorProj.databinding.ActivityPdfDetailBinding;
import com.example.KomeMajorProj.databinding.DialogCommentAddBinding;
import com.example.KomeMajorProj.models.ModelComment;
...
public class PdfDetailActivity extends AppCompatActivity {
    ...
    private AdaptComment adaptComment;
        ...
        ref.child(bookId).child("Comments")
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        adaptComment = new AdaptComment(PdfDetailActivity.this, commentArrayList);

                        binding.commentsRv.setAdapter(adaptComment);
                    }
