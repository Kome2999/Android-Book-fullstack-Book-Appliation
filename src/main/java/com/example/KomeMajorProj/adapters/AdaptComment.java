...
import com.example.KomeMajorProj.databinding.RowCommentBinding;
import com.example.KomeMajorProj.models.ModelComment;

import java.util.ArrayList;

public class AdaptComment extends RecyclerView.Adapter<AdaptComment.HolderComment> {
    ...
    //constructor
    public AdaptComment(Context context, ArrayList<ModelComment> commentArrayList) {
