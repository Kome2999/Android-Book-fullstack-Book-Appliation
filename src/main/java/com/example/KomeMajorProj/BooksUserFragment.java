package com.example.KomeMajorProj;
...
import com.example.KomeMajorProj.databinding.FragmentBooksUserBinding;
...
public class BooksUserFragment extends Fragment {
    ...
    private void loadMostViewedDownloadedBooks(String orderBy) {
        ...
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Books");
        ref.orderByChild(orderBy).limitToLast(10) //load 10  downloaded books
